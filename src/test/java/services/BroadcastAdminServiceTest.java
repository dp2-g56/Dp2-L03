...
public class BroadcastAdminServiceTest extends AbstractTest {
	...
	protected void templateSendMessage(String username, String usernameVerification, String subject, String body, String tags, Class<?> expected) {
